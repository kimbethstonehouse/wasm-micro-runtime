...
if (WAMR_BUILD_TIME_COMPILATION EQUAL 1)
  add_definitions (-DWASM_ENABLE_TIME_COMPILATION=1)
  message ("---  WASM granular compilation timing mode is ON")
else ()
  message ("---  WASM granular compilation timing mode is OFF")
endif ()
if (WAMR_BUILD_COUNT_INSTRUCTIONS EQUAL 1)
  add_definitions (-DWASM_ENABLE_COUNT_INSTRUCTIONS=1)
  message ("---  WASM instruction counting mode is ON")
else ()
  message ("---  WASM instruction counting mode is OFF")
endif ()
if (WAMR_BUILD_DEBUG_LOGGING EQUAL 1)
  add_definitions (-DWASM_ENABLE_DEBUG_LOGGING=1)
  message ("---  WASM debug logging mode is ON")
else ()
  message ("---  WASM debug logging mode is OFF")
endif ()
################## native ##################
